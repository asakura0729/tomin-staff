...
class appConfigUser
{
    ...
    public const list = [
        ...
        '3' => ['userid' => '3', 'loginid' => 'test', 'password' => 'test0509', 'username' => 'スタッフⅡ', 'authority' => self::authorityStaff],
        '4' => ['userid' => '4', 'loginid' => 'master2', 'password' => 'master2', 'username' => '管理者Ⅱ', 'authority' => self::authorityManager],
    ];
}
