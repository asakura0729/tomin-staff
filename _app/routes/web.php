...
class appRoutesWeb
{
    ...
    public const sitemap = [
        ...
        'adminCrm' => ['path' => '/tpadmin/funeral/', 'contents' => '/tpadmin/funeral/ajax', 'title' => '顧客検索'],
    ...
    //======================================================================
    public const ajax = [
        'adminCrmConfirm' => ['path' => '/tpadmin/ajax_edit/confirm', 'title' => 'データ送信'],
        'adminCrmDetailAjaxAddtext' => ['path' => '/tpadmin/ajax_edit/add_text', 'title' => 'テキスト入力フォーム追加'],
        'adminCrmDetailAjaxAddClient' => ['path' => '/tpadmin/ajax_edit/add_client', 'title' => '顧客情報入力フォーム追加'],
        'editAddTel' => ['path' => '/tpadmin/ajax_edit/add_tel', 'title' => '架電日時登録フォーム追加'],
        'adminCrmDetailAjaxReportCs' => ['path' => '/tpadmin/ajax_edit/logs?funeral_id=', 'title' => '過去対応ログ一覧'],
    ];
    //======================================================================
    // グローバルナビゲーション一覧
    //======================================================================
