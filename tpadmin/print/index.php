...
<div class="l-edit">
    <div class="bg-white w-450px h-100 border">
        <form id="form">
            <div class="container">
                <h1 class="font-size-2 text-center pt-4 pb-2">宛名印刷</h1>
                <section class="pb-3">
            ...
            <button type="button" class="btn btn-primary font-size-1_4 p-2 w-75 mx-auto d-block" onclick="window.print();"><i class="fa fa-print pr-2" aria-hidden="true"></i>印 刷</button>
...
<div id="prev" class="l-prev">
    <div class="position-relative print_wrap bg-white mx-auto">
        ...
        <div class="position-bottom-left w-100 font-size-0_8 text-center pb-3">
            資料発送センター<br>
        ...
        <div class="position-relative font-notoserif">
            <div class="row justify-content-end">
                ...
                <div class="position-middle-top pt-name font-size-name vertical-upright h-name"><span id="name" class="pb-name"><span class="color-lgray print_nodisp">都民 太郎</span></span>様</div>
            </div>
        </div>
    </div>
</div>
