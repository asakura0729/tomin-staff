<div class="pb-3">
    <header class="d-flex justify-content-between align-items-center w-100 pb-2">
        ...
        <?php appLibraryDisp::globalModule('form/btn_add', ['add' => 'data-additem data-hx-get="' . appRoutesWeb::ajax['editAddtext']['path'] . '" data-hx-target="#' . $option['id'] . '" hx-swap="afterbegin"']); ?>
    </header>
    <?php /*要改善*/ ?>
