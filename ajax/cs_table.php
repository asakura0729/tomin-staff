...
<?php require_once '../_app/http/ajax/cs_table.php'; ?>
        ...
        <?php foreach (appHttpAjaxCstable::$dbResultCs as $value): ?>
            <div class="d-table-row bg-white bg-hover-lgray">
                <div class="d-table-cell font-size-0_9 m-0 text-center border-right border-bottom">
                    <button id="cs_table-<?php echo $value['cs_id']; ?>" class="btn dropdown-toggle dropdown-after-none position-relative p-3 w-100" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="pos-middle-center d-block color-lgray text-center">
                            <i class="fa fa-ellipsis-v" aria-hidden="true"></i>
                        </span>
                    </button>
                    <div class="dropdown-menu w-200px p-2" aria-labelledby="cs_table-<?php echo $value['cs_id']; ?>">
                        <?php if (appHttpAjaxCstable::$path === appRoutesWeb::sitemap['adminCsEdit']['contents']): ?>
                            <?php /*分岐1：対応ログ編集*/ ?>
                        ...
                        <?php elseif (
                            appHttpAjaxCstable::$path === appRoutesWeb::sitemap['adminCsIndex']['contents'] ||
                            appHttpAjaxCstable::$path === appRoutesWeb::sitemap['adminCsList_invalid']['contents'] ||
                            appHttpAjaxCstable::$path === appRoutesWeb::sitemap['adminCsList_check']['contents']
                        ): ?>
                            <?php /*分岐2：対応ログ一覧*/ ?>
                            <?php appFuncModule::link('chevron', appRoutesWeb::sitemap['adminCsEdit'], ['title' => '対応ログ編集', 'queryParam' => appFuncPath::setGetParam(['cs_id'], [$value['cs_id']])]); ?>
                            ...
                            <?php endif; ?>
                        <?php elseif (appHttpAjaxCstable::$path  === appRoutesWeb::sitemap['adminCsSeet']['contents']): ?>
                            <?php /*分岐3：送客シート一覧*/ ?>
