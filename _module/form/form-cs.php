...
<?php else: ?>
    <div class="<?php echo appFuncCrmForm::setRowWidth($inputName, $inputType); ?> border bg-llgray font-size-0_9" data-disp="<?php echo appFuncCrmForm::setDataDisp($inputName); ?>" data-wrap-inputname="<?php echo $inputName; ?>">
        ...
        <?php elseif ($inputName === appDatabaseCs::table['approval_status']['name']): ?>
            <?php /*分岐：申請*/ ?>
            <div class="form-sheets position-relative">
                <label class="pos-middle-center w-80per">
                    <input name="<?php echo $inputName; ?>" type="checkbox" value="<?php echo appConfigStatus::approval_status['progress']['key']; ?>" class="form-control" <?php echo appFuncString::strlenString($inputValue, "checked"); ?>>
                </label>
            </div>
        <?php elseif ($inputName === appDatabaseCs::table['delivery_status']['name']): ?>
            ...
            <div class="form-sheets position-relative">
                <label class="pos-middle-center w-80per">
                    <input name="<?php echo $inputName; ?>" type="checkbox" value="<?php echo appConfigStatus::delivery_status['required']['key']; ?>" class="form-control" <?php echo appFuncString::strlenString($inputValue, "checked"); ?>>
                </label>
            </div>
